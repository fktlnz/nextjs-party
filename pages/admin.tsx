...
const Home:NextPage = ({data}:any) => {
    ...
    return (
        <div className={styles_admin.container}>
        <Head>
        ...
        <main className={styles_admin.main}>
            
            <h1 className={styles_admin.title}>
            AdminPage!
            </h1>
            ...
            <div css={style_utility.mb30}>
                <ul>
                    <li css={style_utility.mr5}><button css={style_btn.StylePrimaryBtn} onClick={() => display(1)}>公開[タイトル]</button></li>
                    <li css={style_utility.mr5}><button css={style_btn.StylePrimaryBtn} onClick={() => display(2)}>公開[選択肢]</button></li>
                    <li css={style_utility.mr5}><button css={style_btn.StyleSuccessBtn} onClick={() => display(3)}>AnswerCheck</button></li>
                    <li css={style_utility.mr5}><button css={style_btn.StyleSuccessBtn} onClick={() => display(4)}>Answer</button></li>
                    <li css={style_utility.mr5}><button css={style_btn.StyleWarningBtn} onClick={() => display(5)}>終了</button></li>
                    <li><button css={style_btn.StyleDangerBtn} onClick={() => deleteQuestion()}>削除</button></li>
                </ul>
            </div>
            <div>
