...
const Home:NextPage = ({data}:any) => {
    ...
    return (
        ...
        <main className={styles_admin.main}>
            ...
            <div css={style_utility.mb30}>
                <ul>
                    <li css={style_utility.mr5}><button css={style_btn.StylePrimaryBtn} onClick={() => updateTable()}>公開</button></li>
                    <li css={style_utility.mr5}><button css={style_btn.StyleSuccessBtn}>AnswerCheck</button></li>
                    <li css={style_utility.mr5}><button css={style_btn.StyleWarningBtn}>終了</button></li>
